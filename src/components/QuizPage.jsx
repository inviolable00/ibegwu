      ...
      {Number(question) === numberOfQuestions ? (
        ...
        <section className="mt-8 px-6 sm:px-16 xl:flex xl:w-full xl:px-0">
          ...
          <div className="xl:w-1/2">
            ...
            {!showNextQuestion ? (
              <button
                className="bg-['linear-gradient(0deg, rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), #a729f5'] h-14 w-full
                  rounded-xl bg-purple py-2 text-xs font-semibold text-white transition-all duration-200 ease-in-out hover:bg-btnHover sm:h-[92px] sm:rounded-3xl sm:text-[28px] xl:w-[564px]"
