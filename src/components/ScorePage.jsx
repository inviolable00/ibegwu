...
const ScorePage = ({ score, title, icon, iconbg, numberOfQuestions }) => {
  return (
    <section className="mt-8 px-6 sm:px-16 xl:mt-0 xl:flex xl:px-0">
      ...
      <div className="xl:w-1/2 xl:space-y-8">
        ...
        <button
          className="h-14 w-full rounded-xl bg-purple py-2 text-[18px] font-medium text-white transition-all duration-200 ease-in-out hover:bg-btnHover sm:h-[92px] sm:rounded-3xl sm:text-[28px] xl:w-[564px]"
